...
int Interpreter::evaluateExpression(Node* node) {
...
void Interpreter::evaluateFunctionCall(Node* node) {
...
void Interpreter::evaluateIfStatement(Node* node) {
...
void Interpreter::evaluateWhileLoop(Node* node) {
